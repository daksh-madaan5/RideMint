      ...
      <div className="mx-auto max-w-[var(--content-customer)] px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-start justify-between gap-8 rounded-[var(--radius-panel)] bg-[var(--navigation)] px-6 py-10 text-[var(--navigation-text)] sm:px-10 md:flex-row md:items-center">
          <div>
            ...
            <h2 className="mt-3 max-w-xl font-heading text-3xl font-semibold tracking-tight">Compare the fleet and choose with confidence.</h2>
            <p className="mt-3 max-w-xl text-sm leading-6 text-surface-400">Browse demo availability and clear daily rates across RideMint cities.</p>
          </div>
